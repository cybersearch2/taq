...
/**
Demonstrates a receiver attached to a function call operation. 
...
and an attached receiver converts each returned axiom into a list of strings skipping over blank terms 
representing attributes which are not relevant.
 */
public class Birds3
{
...
waterfowl=pintail, family=duck, flight=agile, voice=short whistle<br/>
	...
	{
        QueryProgram queryProgram = queryProgramParser.loadScript("receiver/birds3.taq");
    ...
    public static void main(String[] args)
	{
		try 
		{
	        Iterator<String> iterator = new Birds3().getBirds();
