...
/**
Scans a list of cities with their elevations, for cities whichare at 5,000 feet or higher.
*/
public class HighCitiesSorted 
{
	...
	/**
	 * Compiles the high-cities-sorted.taq script and runs the "high_cities" query, displaying the solution on the console.<br/>
	...
	{
        QueryProgram queryProgram = queryProgramParser.loadScript("flow/high-cities-sorted.taq");
