...
public class Agri20Year1Provider implements FunctionProvider {

	public static final class AgriDataCollback implements ReadAgriData.RecordCallback {
	...
	public static final class AgriDataCallHandler extends CallHandler implements DatabaseSupport {
		...
		public boolean evaluate(List<Term> argumentList) {
			if (!argumentList.isEmpty()) {
				...
				if (provider != null) {
					ReadAgriData readAgriData = new ReadAgriData();
