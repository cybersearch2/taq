...
/**
 * QueryStudentScoresTest
 * @author Andrew Bowley
 */
public class QueryStudentScoresTest
{
	@Before
    ...
    @Test
    public void testQueryStudentScores() throws Exception
    {
        File testFile = ResourceHelper.getResourceFile("query_call/query-student-scores.txt");
        final BufferedReader reader = new BufferedReader(new InputStreamReader(new FileInputStream(testFile), "UTF-8"));
    	List<String> args = new ArrayList<>();
    	args.add("query-student-scores");
