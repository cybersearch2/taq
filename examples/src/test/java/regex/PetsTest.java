...
public class PetsTest
{
    ...
    private void doTest(Taq taq) throws Exception
    {
		...
		if (!taq.execute(query)) {
	        ...
	        File testFile = ResourceHelper.getResourceFile("regex/pets.txt");
    ...
    protected void checkSolution(BufferedReader reader, String pet)
    {
        try
        {
            String line = reader.readLine();
            assertThat(pet).isEqualTo(line);
        }
        catch (IOException e)
        {
            fail(e.getMessage());
