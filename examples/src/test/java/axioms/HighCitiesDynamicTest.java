...
public class HighCitiesDynamicTest
{
    ...
    @Test
    public void testHighCitiesDynamic() throws Exception
    {
    	List<String> args = new ArrayList<>();
    	args.add("high-cities-dynamic");
        ...
        File testFile = ResourceHelper.getResourceFile("axioms/high-cities-dynamic.txt");
