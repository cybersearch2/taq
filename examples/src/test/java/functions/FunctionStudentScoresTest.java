 ...
 * 17Apr,2017
 */
public class FunctionStudentScoresTest
{
	@Before
    ...
    public void testFunctionStudentScores() throws Exception
    {
    	...
    	args.add("function-student-scores");
        Taq taq = new Taq(args);
        List<String> captureList = taq.getCaptureList();
		taq.findFile();
		taq.compile();
		taq.execute();
        File testFile = ResourceHelper.getResourceFile("functions/function-student-scores.txt");
