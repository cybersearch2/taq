...
public class AsiaTopTenTest
{
    ...
    @Test
    public void testiaTopTen() throws Exception
    {
    	List<String> args = new ArrayList<>();
    	args.add("asia_top_ten");
        ...
        File testFile = ResourceHelper.getResourceFile("data_flow/asia_top_ten.txt");
