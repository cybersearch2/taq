...
public class ColorSwatch2Test
{
    ...
    @Test
    public void testColorSwatch2() throws Exception
    {
        File testFile = ResourceHelper.getResourceFile("select/color-swatch2.txt");
