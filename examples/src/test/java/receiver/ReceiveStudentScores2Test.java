 ...
 * 17Apr,2017
 */
public class ReceiveStudentScores2Test
{
	@Before
    ...
    @Test
    public void testReceiveStudentScores2() throws Exception
    {
    	List<String> args = new ArrayList<>();
    	args.add("receive-student-scores2");
        Taq taq = new Taq(args);
        List<String> captureList = taq.getCaptureList();
		taq.findFile();
		taq.compile();
        File testFile = ResourceHelper.getResourceFile("receiver/receive-student-scores.txt");
