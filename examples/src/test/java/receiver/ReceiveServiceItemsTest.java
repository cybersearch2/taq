 ...
 * 17Apr,2017
 */
public class ReceiveServiceItemsTest
{
    ...
    @Test
    public void testReceiveServiceItems() throws Exception
    {
    	List<String> args = new ArrayList<>();
    	args.add("receive-service-items");
        Taq taq = new Taq(args);
        List<String> captureList = taq.getCaptureList();
		taq.findFile();
		taq.compile();
        File testFile = ResourceHelper.getResourceFile("receiver/receive-service-items.txt");
