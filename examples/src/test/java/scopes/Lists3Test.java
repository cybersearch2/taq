...
public class Lists3Test
{
	...
	@Test
    public void testLists3() throws Exception
    {
    ...
    {
        File testFile = ResourceHelper.getResourceFile("scopes/lists3.txt");
    ...
    private List<Axiom> queryLists(Taq taq, String city) 
    {
        ...
        for (String list: LISTS) {
	        ...
	        Iterator<Axiom> iterator = result.axiomIterator(query);
	        iterator.forEachRemaining(axiom -> lists.add(axiom));
        }
        return lists;
    }
