 ...
 */
public class AgricultureReportTest
{
    ...
    @Test
    public void testAgricultureReport1() throws Exception
    {
    	List<String> args = new ArrayList<>();
    	args.add("agriculture-report");
       ...
       Taq taq = new Taq(args);
		...
		String agriSolutionPath = Paths.get(Taq.WORKSPACE, "db", "agri_20_year1").toString();
		ReadAgriSolution readAgriSolution = new ReadAgriSolution();
		ConnectionProfile profile = new ConnectionProfile("agri_20_year1", new H2(), agriSolutionPath);
	...
	private void testAgriPercent(Taq taq) throws IOException {
        ...
        agriculture.provider.ReadAgriData.RecordCallback callback =
        	new agriculture.provider.ReadAgriData.RecordCallback() {
			...
			String agriDataPath = Paths.get(Taq.WORKSPACE, "db", "agri-area-percent1").toString();
			agriculture.provider.ReadAgriData readAgriData = new agriculture.provider.ReadAgriData();
			ConnectionProfile profile = new ConnectionProfile("agri_20_year1", new H2(), agriDataPath);
