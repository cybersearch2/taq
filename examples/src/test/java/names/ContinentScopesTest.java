...
/**
 * EuroScopeMegaCitiesTest
 * @author Andrew Bowley
 * 11Apr.,2017
 */
public class ContinentScopesTest
{
	@Before
    ...
    @Test
    public void testEuropeanScopeMegaCities() throws Exception
    {
    	List<String> args = new ArrayList<>();
    	args.add("continent-scopes");
    	args.add("+case-insensitive");
        Taq taq = new Taq(args);
        List<String> captureList = taq.getCaptureList();
		taq.findFile();
		taq.compile();
		taq.execute("euro_megacities");
		taq.execute("asia_megacities");
        Iterator<String> iterator = captureList.iterator();
        File testFile = ResourceHelper.getResourceFile("names/continent-scopes.txt");
