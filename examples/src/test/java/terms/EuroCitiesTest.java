...
public class EuroCitiesTest
{
    ...
    @Test
    public void testEuroCities() throws Exception
    {
    	List<String> args = new ArrayList<>();
    	args.add("euro_cities");
        ...
        File testFile = ResourceHelper.getResourceFile("terms/euro_cities.txt");
